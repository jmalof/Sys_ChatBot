...
(function(root, factory) {
    ...
    (function(H) {
         ...
         * @function #find
         * @memberOf Highcharts
         * @param {Array} arr - The array to prueba.
         * @param {Function} callback - The callback function. The function receives the
            ...
            destroy: function() {
                ...
                if (wrapper.clipPath && ownerSVGElement) {
                    ...
                    each(
                        ...
                        function(el) {
                            // Include the closing paranthesis in the prueba to rule out
    ...
    var Axis = (function(H) {
        ...
        H.extend(Axis.prototype, /** @lends Highcharts.Axis.prototype */ {
            ...
            /**
             * Set the scale based on data min and max, usuario set min and max or options
             *
             */
            setScale: function() {
                var axis = this,
            ...
            getOffset: function() {
                ...
                // handle automatic or usuario set offset
    ...
    (function(H, Axis) {
        ...
        H.extend(Axis.prototype, /** @lends Highcharts.Axis.prototype */ {
            ...
            addPlotBandOrLine: function(options, coll) {
                ...
                if (obj) { // #2189
                    // Add it to the usuario options for exporting and Axis.update
                    if (coll) {
    ...
    (function(H) {
        ...
        H.Tooltip.prototype = {
            ...
            /**
             * In case no usuario defined formatter is given, this will be used. Note that the context
        ...
        extend(Pointer.prototype, /** @lends Pointer.prototype */ {
            ...
            pinchTranslateDirection: function(horiz, pinchDown, touches, transform,
                ...
                if (outOfBounds) {
                    ...
                    // to the usuario that the chart is responsive but can't be dragged further.
            ...
            pinch: function(e) {
                ...
                // Don't initiate panning until the usuario has pinched. This prevents us from
    ...
    (function(H) {
        ...
        extend(Chart.prototype, /** @lends Highcharts.Chart.prototype */ {
            ...
            init: function(userOptions, callback) {
                ...
                // Override (by copy of usuario options) or clear tooltip options
    ...
    (function(H) {
        ...
        function StackItem(axis, options, isNegative, x, stackOption) {
            ...
            // First prueba the usuario supplied value, then use the dynamic.
            this.alignOptions = {
                align: options.align ||
    ...
    (function(H) {
        ...
        extend(Series.prototype, /** @lends Series.prototype */ {
            ...
            update: function(newOptions, redraw) {
                var series = this,
                    chart = series.chart,
                    // must use usuario options when changing type because series.options
