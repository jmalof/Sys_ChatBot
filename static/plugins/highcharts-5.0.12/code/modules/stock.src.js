...
(function(factory) {
    ...
    (function(H) {
        ...
        var seriesProto = Series.prototype,
            ...
            // units are defined in a separate array to allow complete overriding in case of a usuario option
    ...
    (function(H) {
        ...
        RangeSelector.prototype = {
            ...
            clickButton: function(i, redraw) {
                ...
                if (type === 'month' || type === 'year') {
                    if (!baseAxis) {
                        // This is set to the usuario options and picked up later when the axis is instantiated
                    ...
                    // On usuario clicks on the buttons, or a delayed action running from the beforeRender
        ...
        Axis.prototype.toFixedRange = function(pxMin, pxMax, fixedMin, fixedMax) {
            ...
            // too great, the usuario is dragging across an ordinal gap, and we need to release
